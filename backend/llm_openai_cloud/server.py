        ...
        if prompt_details.get('appType') == "simple":
            if prompt_details.get('promptType') == "simple":
                ...
                if formatted_prompt:
                    ...
                    if simple_response.error:
                        ...
                        input_tokens = simple_response.input_tokens
                        output_tokens = simple_response.output_tokens
                        print(generated_response, input_tokens, output_tokens)
                        ...
                        if cached_input_tokens_data:
                            print(cached_input_tokens_data)
                        ...
                        if cached_output_tokens_data:
                            print(cached_output_tokens_data)
            ...
            if prompt_details.get('promptType') == "system":
                ...
                if SystemMessage and HumanMessage:
                    ...
                    conversational_response, input_tokens, output_tokens = GenerateResponse(mode = mode,
                                                               model = model,
                    ...
                    if conversational_response.error:
                        ...
                        if cached_output_tokens_data:
                            total_output_tokens = cached_output_tokens_data + output_tokens
                            cache[cache_output_tokens_key] = total_output_tokens
                            print("Total output tokens:",total_input_tokens)
                        else:
                            cache[cache_output_tokens_key] = output_tokens
                            print("Total output tokens:", output_tokens)
