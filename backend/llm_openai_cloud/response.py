...
class GenerateResponse:
    def __init__(
        ...
        if self.appType == 'simple':
            ...
            self.response, self.input_tokens, self.output_tokens = self._simple_response()
            ...
            self.response, self.input_tokens, self.output_tokens = self._conversational_response()
    ...
    def _simple_response(self):
        ...
        try:
            ...
            input_token_integr = encoding.encode(self.prompt[0].content)
    ...
    def _conversational_response(self):
        ...
        try:
            ...
            if self.mode == "Private" or self.mode == "Cloud":
                ...
                input_token_integr = encoding.encode(self.humanMessage)
                input_tokens = len(input_token_integr)
