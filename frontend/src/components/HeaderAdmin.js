...
export default function HeaderAdmin({
    ...
    const headingStyle = { position: 'absolute', top: 100, left: '50%', transform: 'translateX(-50%)', textAlign: 'center', width: '100%' };
        ...
        <div className="mb-10">
            ...
            <div ref={menuRef} style={menuStyle} onClick={() => setIsMenuOpen(!isMenuOpen)} id="menu">
                <Menu menuButton={<MenuButton className={textClassName}>
                    ...
                    <MenuItem onClick={handleAdminHomeButton} className={textClassName}>Home</MenuItem>
                    <MenuItem onClick={handleAccountButton} className={textClassName}>Account</MenuItem>
